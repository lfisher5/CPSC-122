...
class List2
{
 ...
 private:
   ...
   */
   ...
   /*
Pre:  arr is an arrray of itemTypes, cur begins the subarray under consideration
Post: returns the smallest item in the array, beginnig with cur
*/
   int findSmallest(itemType arr[], int cur);
   /*
...
*/
   void swap(itemType arr[], int cur, int idxSmallest);
  	/*
